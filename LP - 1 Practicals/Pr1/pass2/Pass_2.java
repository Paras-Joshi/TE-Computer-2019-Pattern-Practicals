...
public class Pass_2 {
	...
	public static void main(String[] args) {
		...
		try {
			pass2.generateCode("C:\\Users\\patil\\OneDrive\\Documents\\assembler\\assember1\\pass2\\IC.txt");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void readtables() {
		...
		String line;
		try {
			br = new BufferedReader(new FileReader("C:\\Users\\patil\\OneDrive\\Documents\\assembler\\assember1\\pass2\\SYMTAB.txt"));
			while ((line = br.readLine()) != null) {
				String parts[] = line.split("\\s+");
				SYMTAB.add(new TableRow(parts[1], Integer.parseInt(parts[2]), Integer.parseInt(parts[0])));
			}
			br.close();
			br = new BufferedReader(new FileReader("C:\\Users\\patil\\OneDrive\\Documents\\assembler\\assember1\\pass2\\LITTAB.txt"));
			while ((line = br.readLine()) != null) {
				String parts[] = line.split("\\s+");
	...
	public void generateCode(String filename) throws Exception {
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\patil\\OneDrive\\Documents\\assembler\\assember1\\pass2\\PASS2.txt"));
		String line, code;
		while ((line = br.readLine()) != null) {
			String parts[] = line.split("\\s+");
